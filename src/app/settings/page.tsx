...
import UserProfileSettingsCard from "@/app/settings/components/UserProfileSettingsCard";
        ...
        <div className="lg:w-2/3 sm:w-3/4 w-full">
          ...
          <main className="px-5 py-2.5 space-y-8 [&_.settings-card]:rounded-sm [&_.settings-card]:border-b [&_.settings-card]:border-base-content/5">
            ...
            <div className="sm:px-5 pb-3 settings-card">
              <h2 className="text-lg font-medium opacity-70 mb-2">ASPETTO</h2>
                  ...
                  >
                    ...
                    <Link href={license.link}>
                      <button type="button" className="d-btn d-btn-ghost">
                        <i
                          className="bi bi-box-arrow-up-right text-2xl"
                          aria-hidden
                        ></i>
                      </button>
                    </Link>
