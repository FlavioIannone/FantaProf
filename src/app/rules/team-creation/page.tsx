export default function TeamCreationRule() {
  return (
    <>
      ...
      <h3 className="opacity-0 lg:text-2xl sm:text-xl text-xl lg:mb-10 md:mb-8 sm:mb-7 mb-6 sm:animate-fade-in-top animate-fade-in-left sm:animation-delay-700 animation-delay-300 motion-reduce:animate-none">
      ...
      <h3 className="opacity-0 lg:text-2xl sm:text-xl text-xl lg:mb-4 md:mb-4 sm:mb-3 mb-2 sm:animate-fade-in-top animate-fade-in-left sm:animation-delay-700 animation-delay-300 motion-reduce:animate-none">
        <p className="opacity-80">
