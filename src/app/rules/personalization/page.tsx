      ...
      <div>
        ...
        <ul>
          <li className="lg:mb-7 md:mb-6 sm:mb-5 mb-5">
            <h4 className="lg:text-4xl md:text-2xl sm:text-xl text-xl text-primary lg:mb-2 md:mb-2 sm:mb-2 mb-1 opacity-0 sm:animate-fade-in-top animate-fade-in-left motion-reduce:animate-none">
              Modifica del Valore di Bonus e Malus
            </h4>
            <ul>
              <li className="opacity-0 sm:animate-fade-in-top animate-fade-in-left animation-delay-300 motion-reduce:animate-none">
                <p className="lg:text-2xl sm:text-xl text-xl opacity-70">
