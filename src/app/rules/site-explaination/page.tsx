export default function SiteExplainationRule() {
  return (
    <>
      <h1 className="lg:text-6xl md:text-4xl sm:text-3xl text-3xl text-primary lg:mb-3 md:mb-3 sm:mb-2 mb-1 motion-safe:opacity-0 sm:animate-fade-in-top animate-fade-in-left motion-reduce:animate-none">
